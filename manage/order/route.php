...
if($sort_order == 'desc'){
   $sortorder = 'ORDER BY quantity DESC, pay_time DESC, id DESC';
}else if($sort_order == 'asc'){
   $sortorder = 'ORDER BY quantity ASC, pay_time DESC, id DESC';
}else{
   $sortorder = 'ORDER BY pay_time DESC, id DESC';
}
...
include template('manage_order_route');

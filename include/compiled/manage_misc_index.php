    ...
    <div id="content" class="coupons-box clear mainwide">
		<div class="box clear">
            <div class="box-content">
                <div class="head">
                    <h2> 
					    最土软件升级版(<?php echo SYS_VERSION; ?>_<?php echo SYS_SUBVERSION; ?>)
					    [<a href="/manage/misc/add_database.php">升级数据库结构</a>]
					</h2>
				</div>
				<div class="sect">
					<?php if(is_manager(1)){?>
                    ...
                    <table style="width:100%;" cellpadding="5" cellspacing="0" border="1" bordercolor="#e8e6e4">
                    <tr valign="middle">
                        <td></td>

...
<!--		
			...
			<div class="headtxt"><img src="/static/0750/images/top_font.png" width="110px" height="60px"></div>
<?php 
$pteams = get_cart_team();
; ?> 
			<div class="scart"><a href="/cart/index.php"><div class="cartnum"><p><?php echo $pteams['num']; ?></p></div></a><div class="carttxt"><p><a class="black" href="/cart/index.php">购物车</a></p><p>件-$<?php echo $pteams['all_price']; ?></p></div><div class="loginbg"></div></div>
		</div>
		<div class="nav">
			<div class="bignavul">
			<div class="navul">
...
; ?>
		...
		<?php if($login_user){?>
                	...
                	<ul>
				<li style="width:100px;"><a style="background:none; font-size:14px;" href="/account/settings.php"><?php echo mb_strimwidth($login_user['username'],0,10); ?></a></li>
				<li style="width:58px;"><a style="background:none; font-size:14px;" href="/account/logout.php">退出</a></li>
				</ul>
		<?php } else { ?>
				<ul>
				<li style="background-image:none"><a class="white" href="/account/login.php">登陆</a></li>

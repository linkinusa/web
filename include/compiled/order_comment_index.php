	...
	<div class="content">
	  ...
	  <div class="usercenterright">
        ...
        <?php if(is_array($orders)){foreach($orders AS $index=>$one) { ?>
              <?php if($_GET['os'] == 'ok' && get_comment_order($one['id'])){?>
			<div class="tablediv">
		    <table width="875" border="1" cellspacing="0" cellpadding="0">
              ...
              <tr>
				...
				<div class="tabledivclass">
					...
					<p class="tabledivclassaddress"><?php echo getpartner($one['team_id']); ?><img src="/static/0750/images/redaddress.png"/></p>
					<p class="tabledivclassmore">

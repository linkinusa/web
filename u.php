...
<title>PHP探针-UPUPW环境集成包KANGLE专用版</title>
...
<meta name="description" content="UPUPW环境集成包KANGLE专用版PHP探针可检测ZendOptimizer,ZendGuardLoader,ionCube,eAccelerator,memcache,XCache,WinCache和SendMail等PHP组件." />
